...
### Main (potentially lifelong) Project's Status
- [Ataraxia](https://github.com/1neskk/Ataraxia)'s development is **on hold** (middle stage).
- [CFD](https://github.com/1neskk/CFD)'s development is **on hold** (early stage).
- [LemmaSAT](https://github.com/1neskk/LemmaSAT)'s development is **on hold** (early stage).
